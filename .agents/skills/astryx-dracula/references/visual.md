...
Contact-form verdict: the single `variant="section"` band in `templates/contact-form.tsx` is the known exception under review — new pages must not copy it; use the default AppShell variant plus the body/surface tiers above.
